...
def BRFN():
    ...
    plt.subplot(241), plt.imshow(img, "gray"), plt.title("Original", fontsize=8)
    plt.subplot(245), plt.imshow(np.log(1+np.abs(fshift)), cmap='gray'), plt.title("Original", fontsize=8)
    plt.subplot(242), plt.imshow(idealBrfN, "gray"), plt.title("Ideal BRFN", fontsize=8)
    plt.subplot(246), plt.imshow(np.abs(inverseIdealBrfN), "gray"), plt.title("Ideal BRFN", fontsize=8)
    plt.subplot(243), plt.imshow(butterBrfN, "gray"), plt.title("Butterworth BRFN", fontsize=8)
    plt.subplot(247), plt.imshow(np.abs(inverseButterBrfN), "gray"), plt.title("Butterworth BRFN", fontsize=8)
    plt.subplot(244), plt.imshow(gaussBrfN, "gray"), plt.title("Gaussian BRFN", fontsize=8)
    plt.subplot(248), plt.imshow(np.abs(inverseGaussBrfN), "gray"), plt.title("Gaussian BRFN", fontsize=8)
    plt.show()
...
def BPFN():
    ...
    plt.subplot(241), plt.imshow(img, "gray"), plt.title("Original", fontsize=8)
    plt.subplot(245), plt.imshow(np.log(1+np.abs(fshift)), cmap='gray'), plt.title("Original", fontsize=8)
    plt.subplot(242), plt.imshow(idealBpfN, "gray"), plt.title("Ideal BRFN", fontsize=8)
    plt.subplot(246), plt.imshow(np.abs(inverseIdealBpfN), "gray"), plt.title("Ideal BRFN", fontsize=8)
    plt.subplot(243), plt.imshow(butterBpfN, "gray"), plt.title("Butterworth BRFN", fontsize=8)
    plt.subplot(247), plt.imshow(np.abs(inverseButterBpfN), "gray"), plt.title("Butterworth BRFN", fontsize=8)
    plt.subplot(244), plt.imshow(gaussBpfN, "gray"), plt.title("Gaussian BRFN", fontsize=8)
    plt.subplot(248), plt.imshow(np.abs(inverseGaussBpfN), "gray"), plt.title("Gaussian BRFN", fontsize=8)
    plt.show()
